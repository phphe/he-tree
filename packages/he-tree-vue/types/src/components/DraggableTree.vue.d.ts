...
export declare const context: {
    ...
    readonly startTree: ({
        ...
        }>> & VNodeProps & AllowedComponentProps & ComponentCustomProps, ("rtl" | "indent" | "table" | "processor" | "childrenKey" | "defaultOpen" | "updateBehavior" | "textKey" | "virtualization" | "virtualizationPrerenderCount" | "btt") | ("disableDrag" | "disableDrop" | "rootDroppable" | "dragOpen" | "dragOpenDelay" | "keepPlaceholder" | "dragCopy")>;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
